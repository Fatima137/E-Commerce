...
import EmptyCart from "../assets/Images/cartt.jpg";
...
export const Cart = () => {
    ...
    const [address, setAddress] = useState('Main Street, Wapda Town, Block B, Lahore, Pakistan');
                    ...
                    <div className='flex flex-col md:flex-row justify-between items-start md:items-center space-y-4 md:space-y-0 md:space-x-10 mt-8'>
                                ...
                                <div key={product.id} className='flex items-center justify-between p-3 border-b'>
                                    ...
                                    <div className='flex space-x-12 items-center'>
                                        ...
                                        <div className='flex items-center justify-center'>
                                            ...
                                            <p className='text-xl px-1.5'>{product.quantity}</p>
                        ...
                        <div className='md:w-1/3 bg-white p-6 rounded-lg shadow-md border'>
                            ...
                            <div className='mb-4 border-b pb-2'>
                                ...
                                <button className='text-blue-800 hover:underline mt-1 ml-2'
                            ...
                            <button className='w-full bg-amber-600 text-white py-2 hover:bg-amber-800' 
